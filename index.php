    ...
    <body id="page-top">
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Our Achievement This Year</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted"><a href="https://www.jhs.tohoku-gakuin.ac.jp/career/univ.html">Tokyo University 2<br>Tohoku University 10<br>and so on...</a></p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">May 22th/29th, June 26th, July 10th<br>You can get to know about our school life!</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">Elementary school students: Jul 31st<br>Junior high school students: Aug 6th/7th</p></div>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="timeline-panel">
                            <div class="timeline-heading">
                                <h4>Check & Challenge Our School!</h4>
                                <h4 class="subheading">For Students & Parents</h4>
                            </div>
                            <div class="timeline-body"><p class="text-muted">Elementary school students: Oct 30th, Nov 6th/20th/27th<br>Junior high school students: Oct 16th/30th, Nov 6th/27th</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-muted">For JHS Jan 6th<br>For HS Feb 1st/3rd</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                ...
                <div class="row">
                <div class="col-lg-8 mx-auto text-center"><p class="large text-muted">If you are interested in our school or this website, please feel free to contact us!</p></div>
                </div>
            </div>
        </section>
        <!-- Clients-->
