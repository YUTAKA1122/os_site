...
<body>
    ...
    <?php
      ...
      background-image: url('assets/img/nice2.jpg');
      ...
      height: 100vh;">
        ...
        <div class="col-10 mx-auto">
            ...
            <?php
            if($item_id == 1){
            echo "<iframe src='assets/FM_Time.pdf' frameborder='0' height='300'></iframe>";
            }elseif($item_id == 2){
                echo "<iframe src='assets/OS_Time.pdf' frameborder='0' height='300'></iframe>";
            }elseif($item_id == 3){
                echo "<iframe src='assets/C&C_Time.pdf' frameborder='0' height='300'></iframe>";
            }else{
