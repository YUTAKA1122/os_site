      ...
      height: 100vh;">
        ...
        <div class="row">
                ...
                if ($userItemCondition == "reserved") {
                    echo "You've already reserved this event.";
                    if($item_id == 2){
                    ?>
                    <table>
                    <thead>
                        ...
                        <tr>
                            ...
                            <td><a href="removeCheck.php?cart_id=<?php echo $cart['cart_id']?>" class="btn btn-primary w-75">Cancel</a>
                            <a href="updateEventUI.php?cart_id=<?php echo $cart['cart_id']?>" class="btn btn-primary w-75">Update</a></td>
                        </tr>
                        </tbody>
                    </table>
                    <?php
                    ...
                    <thead>
                        ...
                        <tr>
                            <td><?php echo $cart['idate']?></td>
                            <td><?php echo $act1['aname']?></td>
                            <td><a href="removeCheck.php?cart_id=<?php echo $cart_id?>" class="btn btn-primary w-75">Cancel</a>
                            <a href="updateEventUI.php?cart_id=<?php echo $cart_id?>" class="btn btn-primary w-75">Update</a></td>
                        </tr>
                    </thead>
                    </table>
                    <?php
